...
def normalize_account_context(data: dict[str, Any], base_url: str = '') -> list[dict[str, Any]]:
...
def whoami(client: MailchimpClient, root_data: dict[str, Any] | None = None) -> list[dict[str, Any]]:
    """Fetch and normalize authenticated account context."""
