...
To verify the installed entrypoint and package imports, run these commands after the editable install:

```bash
mcr --help
cd /tmp && python -c "import mcr, mcr.main; print(mcr.main.build_parser().prog)"
```
